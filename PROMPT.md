# TOMS Operator — AI Design Prompt Guide

> Copy any of the prompts below when working with AI tools (Claude, Cursor, Copilot, etc.).
> Always provide both DESIGN.md and preview.html as context for best results.

---

## Quick Links

- **DESIGN.md (raw)**: https://raw.githubusercontent.com/youyoubt/toms-design/main/DESIGN.md
- **Preview**: https://youyoubt.github.io/toms-design/preview.html

---

## 1. Project-Level System Prompt
> Paste into Claude Projects / Cursor Rules / Copilot Instructions — set it once, use forever.
...
## 2. New Page Prompt
> Use when building a new module page from scratch.
...
具体业务需求：
[在此描述你的页面内容，如：终端列表，字段包括 TID / 型号 / 商户 / 状态 / 最后在线时间]
```

---

## 3. Single Component Prompt
...
## 5. Form / Configuration Page Prompt
...
## 6. Quick Color Cheatsheet
> Copy this into any prompt for instant color context.
